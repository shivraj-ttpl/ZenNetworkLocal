...
export default function StandardDepressionScreeningDrawer({
  open,
  onClose,
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-neutral-50 text-left border-b border-border">
                    <th className="px-4 py-3 font-medium text-text-secondary w-14">
                      Sr. No
                    </th>
                ...
                <tbody>
                  {QUESTIONS.map((q, idx) => (
                    <tr key={q.key} className="border-t border-border">
                      ...
                      <td className="px-4 py-4 text-text-primary align-top">
                        {q.text}
                      </td>
                      {OPTIONS.map((opt) => (
                        <td
