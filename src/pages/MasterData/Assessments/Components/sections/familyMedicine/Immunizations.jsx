...
export default function Immunizations({ values, setFieldValue }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-base font-semibold text-text-primary">Adult Immunizations</h3>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-neutral-50 text-left">
              ...
              <th className="px-4 py-3 font-medium text-text-secondary min-w-[160px]">Vaccine</th>
              <th className="px-4 py-3 font-medium text-text-secondary text-center w-24">Received</th>
              <th className="px-4 py-3 font-medium text-text-secondary min-w-[180px]">Date</th>
              <th className="px-4 py-3 font-medium text-text-secondary min-w-[200px]">Do not want/Why</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={vaccine.key} className="border-t border-border">
                ...
                <td className="px-4 py-3 text-center">
                  <Checkbox
                    ...
                    onChange={() =>
                      setFieldValue(`immunizations.${vaccine.key}.received`, !imm[vaccine.key]?.received)
                    }
                    variant="blue"
                  />
                </td>
                <td className="px-4 py-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFieldValue(`immunizations.${vaccine.key}.dateReceived`, e.target.value)
                    }
                ...
                <td className="px-4 py-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFieldValue(`immunizations.${vaccine.key}.doNotWantReason`, e.target.value)
                    }
