...
export default function FamilyCommunitySupport({ values, handleChange }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h3 className="text-base font-semibold text-text-primary">Family and Community Support</h3>

      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium text-text-primary">
          1. If for any reason you need help with day-to-day activities such as bathing,
