...
export default function Transportation({ values, handleChange }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h3 className="text-base font-semibold text-text-primary">Transportation</h3>

      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium text-text-primary">
          1. In the past 12 months, has lack of reliable transportation kept you from medical
