    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium text-text-primary">
          1. Because of a physical, mental, or emotional condition, do you have
      ...
      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium text-text-primary">
          2. Because of a physical, mental, or emotional condition, do you have
          difficulty doing errands alone such as visiting a doctor&apos;s office
          or shopping? (15 years old or older)
        </p>
        {YES_NO.map((opt) => (
          <label key={opt} className="flex items-center gap-2 cursor-pointer">
            <input
